...
def anisotropic_intrusions(trajectory, radius, lambda_param=2.0):
    ...
    :param lambda_param: factor by which to stretch radius parameter, defaults to 2.0
    ...
    :return: Number of times front, side, and back intrusions happen in trajectory.
